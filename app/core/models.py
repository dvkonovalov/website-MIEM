...
class Professors(models.Model):
    ...
    scientific_title: models.CharField = models.CharField(
        max_length=50,
        blank=False,
        verbose_name='Ученое звание',
    )

    email_addres: models.EmailField = models.EmailField(
        max_length=100,
        blank=False,
    ...
    external_link: models.CharField = models.CharField(
        max_length=150,
        blank=False,
